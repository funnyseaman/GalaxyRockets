...
<div id="container">
    ...
    <div class="row" id="main">
      ...
      <div id="left">
        <ul>
        <%
        	String sql="where user_id in(select focused_user_id from Focus where user_id = "+user.getUser_id()+") ";
          ...
          <li>
            <div class="task">
              <div class="userinfo">
                ...
                <button class="btn btn-primary btn-lg focus" data-toggle="modal" value="<%=task_author %>">
                   <%=buttonText %>
                </button>
                <div class="clear"></div>
              </div>
