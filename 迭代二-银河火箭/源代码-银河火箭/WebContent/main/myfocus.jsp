    ...
    <div class="row" id="main">
     <ul class="nav nav-tabs">
      ...
      <div id="left">
        ...
        <ul>
        	<%
        			String sql="where task_author in(select focused_user_id from Focus where user_id = "+user.getUser_id()+") AND tree_level = 1 ORDER BY task_date DESC";
            		List<Task> tasks = (List<Task>)Dao.select(sql, Task.class);
			    	for(Task task:tasks){
